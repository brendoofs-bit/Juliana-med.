...
const dir = 'ultramed-hof-medical-san';
...
const replacements = {
    'Hakon - Alta Performance': 'Ultramed HOF Medical San - Ultrassom Micro e Macrofocado',
    'Cód: ME21364A': 'Cód: ME20933A',
    'Hakon Medical San - Equipamento de Laser para Epilação Premium 4D': 'Ultramed HOF - Ultrassom Micro e Macrofocado',
};
...
// Sales Desc
const salesDesc = `O Ultramed HOF é a sua ferramenta definitiva para harmonização facial e corporal de alto padrão. Combinando ultrassom micro e macrofocado em uma tecnologia de ponta, ele proporciona lifting imediato e redução de gordura localizada com precisão cirúrgica, sem a necessidade de cortes. Com design inteligente que automatiza parâmetros de dosimetria, você garante resultados superiores e duradouros, elevando a satisfação dos seus clientes e o prestígio da sua clínica. Invista na evolução da estética e destaque-se com a performance que seus pacientes merecem!`;
...
// Clean images
html = html.replace(/https:\/\/res\.cloudinary\.com\/doqw5aqcf\/image\/upload\/v\d+\/.*?\.png/g, 'https://placehold.co/600x400?text=Ultramed+HOF');

fs.writeFileSync(dir + '/index.html', html);
console.log('Ultramed HOF build success');
